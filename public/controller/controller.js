...
alert("dummy"+$scope.remainingBalance)
...
//alert("KKzz"+$scope.remainingNtWt)
                                                       var usecase = user1 +","+$scope.invoice+","+$scope.remainingNtWt; 
                                                            console.log(usecase);
